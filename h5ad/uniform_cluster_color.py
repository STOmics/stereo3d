...
def uniform_cluster_color(
    ...
    ### 01. 选择adatas, 这里选择一二三分位数的adata用于构造参考h5ad,用户可以自己从多片数据中进行选择
    ...
    # data_all.tl.raw
    # data_all.tl.highly_variable_genes(min_mean=0.0125, max_mean=3, min_disp=0.5, res_key='highly_variable_genes', n_top_genes=2000)
