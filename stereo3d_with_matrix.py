...
from register.mask_crop import cut_mask
...
class Stereo3DwithTissueMatrix(object):
    ...
    def _register(self, crop_mask_path):
        from register.registration import align_slices
        # align mask
    ...
    def _transform_gem(self, ):
        from gem.transform import trans_gem_by_json
    ...
    def _create_outermost_surface(self, align_output_path, pixel4mm=0.0005):
        from mesh.create_mesh_3d import get_mask_3d_points
        from mesh.create_mesh_3d import points_3d_to_mesh
    ...
    def _insert_organ(self, align_matrix: str):
        from h5ad.txt2adata import batch_cluster, batch_spatial_leiden
        from h5ad.uniform_cluster_color_v2 import uniform_cluster_color
        from h5ad.uniform_cluster_color_v2 import read_and_parse_by_celltype
        from h5ad.uniform_cluster_color_v2 import organ_mesh
        ...
        for c in tqdm.tqdm(categories, desc='Organ'):
