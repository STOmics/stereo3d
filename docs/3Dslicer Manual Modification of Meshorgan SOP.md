# **3Dslicer Manual Modification of Meshes **
...
● commonly used tools in 3D Slicer software

The five tools under "Welcome to Slicer", with the specific functions of each tool shown in Figure 1.
